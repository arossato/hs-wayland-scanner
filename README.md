...
Definition
Language](https://wayland.freedesktop.org/docs/book/Message_XML.htm). It
...
[MicroHs](https://github.com/augustss/MicroHs.git):
...
handling, is [xml](https://github.com/GaloisInc/xml) that must be
...
It is also possible to create a configuration file and run `hws -c
path/to/config`. The included examples will ship a configuration file
